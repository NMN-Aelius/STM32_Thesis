...
#define GearboxStep_DtoP 13.7*816/90 // gear box of step motor
...
{
	if(Flag_Uart == UART_OK) ReadUart(1);
...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
    ...
    /* USER CODE BEGIN 3 */
		...
		HAL_GPIO_TogglePin(A6_GPIO_Port, A6_Pin);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, A6_Pin|A7_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : A6_Pin A7_Pin */
